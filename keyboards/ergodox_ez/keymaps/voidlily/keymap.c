...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,        LCTL_T(KC_Z),  KC_X,   KC_C,   KC_V,   KC_B,   ALL_T(KC_LBRC),
        LT(SYMB,KC_GRV),KC_NO,        KC_LALT,KC_LEFT,KC_RGHT,
        ...
        MEH_T(KC_RBRC),   KC_N,   KC_M,   KC_COMM,KC_DOT, RCTL_T(KC_SLSH),   KC_RSFT,
